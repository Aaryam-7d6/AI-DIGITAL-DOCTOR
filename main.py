...
@app.route('/ipop')
def ipop():
    return render_template("ipop.html")'''
...
def predict():
    ...
    #while True:
        ...
        if symptoms =="Symptoms":
            ...
            predicted_procotions = predict_per(user_symptoms)
            my_precautions = []
            for i in precautions[0]:
                my_precautions.append(i)
                
            return render_template('predict.html',predicted_disease=predicted_disease,predicted_procotions = predicted_procotions,dis_des=dis_des,my_precautions=my_precautions, medications=medications, my_diet=rec_diet,workout=workout)
            #return render_template("ipop.html")
    #print("else part")                        
